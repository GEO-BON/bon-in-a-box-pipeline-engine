...
<strong>If you need specific version of an already installed library</strong>, such a when a breaking change occured and the script cannot be easily adapted to use the new version.

...
2.  Fork the bon-in-a-box-pipelines repository to your personal GitHub repository

    1.  Documentation on working with forks can be found [here](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/fork-a-repo)
...
5.  When it is complete, create a pull request ([instructions here](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request)) to the main branch on the bon-in-a-box-pipelines GitHub and fill out the [peer review template](https://github.com/GEO-BON/bon-in-a-box-pipelines/pull/188/commits/8f33d28fc691b7bf0ed1bffe00330076c7271cf3), suggesting at least two potential peer reviewers
...
8.  The BON in a Box team will contact you for any bug fixes or feature requests, and new releases will follow the versioning structure below
...
Any `error` message will also halt the script and the rest of the pipeline. It is recommended to output specific error messages to avoid crashes when errors can be foreseen. This can be done using `biab_error_stop` helper function, or by writing an "error" attribute to the `output.json` file.

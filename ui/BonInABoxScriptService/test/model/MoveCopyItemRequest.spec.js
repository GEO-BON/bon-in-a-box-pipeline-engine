...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BonInABoxScriptService.MoveCopyItemRequest();
  });
  ...
  describe('MoveCopyItemRequest', function() {
    it('should create an instance of MoveCopyItemRequest', function() {
      // uncomment below and update the code to test MoveCopyItemRequest
      //var instance = new BonInABoxScriptService.MoveCopyItemRequest();
      //expect(instance).to.be.a(BonInABoxScriptService.MoveCopyItemRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BonInABoxScriptService.GetHistory200ResponseInner();
  });
  ...
  describe('GetHistory200ResponseInner', function() {
    it('should create an instance of GetHistory200ResponseInner', function() {
      // uncomment below and update the code to test GetHistory200ResponseInner
      //var instance = new BonInABoxScriptService.GetHistory200ResponseInner();
      //expect(instance).to.be.a(BonInABoxScriptService.GetHistory200ResponseInner);
    });

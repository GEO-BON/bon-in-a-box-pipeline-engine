...
export default class DefaultApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getCountryRegionBbox operation.
     * @callback module:api/DefaultApi~getCountryRegionBboxCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} id A code, not a name. ISO3 for a country (Colombia is COL), adm1_src for a region.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [type = 'country')] Whether `id` names a country (adm0) or a subnational region (adm1)
     * @param {String} [crs = 'EPSG:4326')] CRS the bounding box is expressed in.
     * @param {module:model/String} [outputFormat = 'bbox')] `chooser_input` for the whole selector object, to fill in an input. `bbox` for only the four numbers. 
     * @param {module:api/DefaultApi~getCountryRegionBboxCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    getCountryRegionBbox(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getCountryRegionBbox");
      }
      ...
      let returnType = Object;
      return this.apiClient.callApi(
        '/region/country_region_bbox', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getServerStatus operation.
     * @callback module:api/DefaultApi~getServerStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetServerStatus200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

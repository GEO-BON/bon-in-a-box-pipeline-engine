        ...
        <div className="navigation-bar">    {/* added the navigation bar */}
          <nav>
              <NavLink 
                ...
                style={{paddingLeft: '60px', fontWeight : "600"}}
                >Home
              </NavLink>
              <NavLink 
                to="/script-form"
              ...
              <NavLink 
                to="https://geo-bon.github.io/bon-in-a-box-pipeline-engine/how_to_contribute.html#instructions-for-adapting-your-code-to-an-analysis-pipeline" 
                target="_blank"
                className="navigation-bar-link help-link"
                style={{ fontWeight : "bold", display: "flex", alignItems: "center", gap: "6px", fontSize : "16px"}}
                >
                   <img 
                    src={HelpIcon} 
                    alt="Help Icon" 

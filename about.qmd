...
![Simplified pipeline with steps (blue), intermediate results (grey), and final results (green)](pipeline.png.png){alt="Simplified pipeline with steps (blue), intermediate results (grey), and final results (green)"}

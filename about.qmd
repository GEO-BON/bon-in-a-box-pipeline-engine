...
BON in a Box serves as a hub for Biodiversity Observation Networks (BONs), consolidating diverse tools and resources to enhance data analysis and collaboration, as well as a project catalogue. _For more information about BON in a Box in general, please refer to [BON in a Box's website](https://boninabox.geobon.org/about)_

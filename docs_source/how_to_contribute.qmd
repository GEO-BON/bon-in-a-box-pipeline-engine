...
compute: # Optional, specify compute requirements for kubernetes or HPC clusters. If absent, default values apply.
  hpc: false # Send to a HPC cluster, if available

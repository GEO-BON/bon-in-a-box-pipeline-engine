...
| "Type" attribute in the yaml | IU rendering |
|------------------------------|--------------|
| boolean                      | Plain text   |
| float, float\[\]             | Plain text   |
| int, int\[\]                 | Plain text   |
| options (INSERT FOOTNOTE)    | Plain text   |
...
| GeoTIFF (INSERT FOOTNOTE) | application/geopackage+sqlite3 | Link                         |
| JPG                       | image/tiff;application=geotiff | Map widget (leaflet)         |
...
A pipeline is a collection of steps to acheive the desired processing. Each script becomes a pipeline step. ![image](https://user-images.githubusercontent.com/6223744/211096047-d1d205e3-2f5e-4af6-b8c5-015b002432cb.png)

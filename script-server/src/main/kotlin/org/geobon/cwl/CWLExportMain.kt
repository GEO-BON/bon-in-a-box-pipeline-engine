...
object CWLExportMain {
    ...
    private val systemCall = SystemCall(Runtime.getRuntime().availableProcessors())
    ...
    suspend fun makeTemplate(cwlFile: File) {
        ...
        if (templateResult.success) {
            ...
            logger.warn(templateResult.error)
        }
    }

...
label: Aggregate outputs and constant to int[]
doc:
  - |
    Description:
...
steps:
  ...
  prepareEnvironments:
    ...
    run:
      ...
      requirements:
        ...
        DockerRequirement:
          dockerPull: ghcr.io/geo-bon/bon-in-a-box-pipelines/runner-conda-cwl:latest
        EnvVarRequirement:
          envDef:
  ...
  assertArray.yml@3:
    ...
    in:
      array:
        source: [0in1out.yml@0/randomness, 0in1out.yml@1/randomness]

...
1.  **The pipeline editor won't let you save your pipeline**

    Errors in saving pipelines are usually due to incompatible inputs and outputs. When you change inputs or outputs in the YAML file, this won't automatically change on the pipeline editor. When adding inputs, reload the pipeline editor so it reflects your changes. When changing the file formats of inputs or outputs, you will need to delete the edited script from the pipeline and re-drag it into the pipeline editor so that it can be saved.

2.  **The pipeline can't find your packages**
...
If you encounter further errors, please contact us on [discourse](https://can01.safelinks.protection.outlook.com/?url=https%3A%2F%2Fdiscourse.geobon.org%2F&data=05%7C02%7Cjory.griffith%40mcgill.ca%7Cb05c119d71864b45735308dd5a68c263%7Ccd31967152e74a68afa9fcf8f89f09ea%7C0%7C0%7C638766128163579549%7CUnknown%7CTWFpbGZsb3d8eyJFbXB0eU1hcGkiOnRydWUsIlYiOiIwLjAuMDAwMCIsIlAiOiJXaW4zMiIsIkFOIjoiTWFpbCIsIldUIjoyfQ%3D%3D%7C0%7C%7C%7C&sdata=sEns2YcaYWSBIxznG0Y38D2hgpwwFABmXtS1ya4QT8k%3D&reserved=0) or email us at boninabox\@geobon.org.

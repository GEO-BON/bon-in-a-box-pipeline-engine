...
# Does your analysis pipeline fit in BON in a Box?
...
To check if the packages you need are already in the default conda environment, go to runners/conda/r-environment.yml or runners/conda/python-environment.yml in the BON in a Box project folder. The list of packages already installed will be under "dependencies".
